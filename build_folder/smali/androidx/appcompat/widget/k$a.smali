...
# interfaces
.implements Landroidx/appcompat/widget/z0$f;
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/e1;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Landroidx/appcompat/widget/e1;->b:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/e1;->e:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/e1;->c:[I
    ...
    sget-object p1, Landroidx/appcompat/widget/e1;->i:[I
...
.method private i(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/e1;->c(Landroid/content/Context;I)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/e1;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v6, Landroidx/appcompat/widget/e1;->b:[I
    ...
    sget-object v5, Landroidx/appcompat/widget/e1;->f:[I

    aput-object v5, v1, v4

    sget v5, Lc/a;->s:I

    invoke-static {p1, v5}, Landroidx/appcompat/widget/e1;->c(Landroid/content/Context;I)I
    ...
    :cond_0
    sget-object v2, Landroidx/appcompat/widget/e1;->b:[I

    aput-object v2, v1, v5

    sget v2, Lc/a;->v:I

    invoke-static {p1, v2}, Landroidx/appcompat/widget/e1;->b(Landroid/content/Context;I)I

    move-result v2

    aput v2, v0, v5

    sget-object v2, Landroidx/appcompat/widget/e1;->f:[I
    ...
    sget-object v2, Landroidx/appcompat/widget/e1;->i:[I
...
.method private l(Landroidx/appcompat/widget/z0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 4
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/z0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Lc/e;->G:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/z0;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
# virtual methods
.method public a(Landroidx/appcompat/widget/z0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    .locals 3
    ...
    :goto_0
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/k$a;->l(Landroidx/appcompat/widget/z0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Ld/a;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, p2}, Landroidx/appcompat/widget/e1;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    :cond_5
    invoke-static {p1, p2}, Landroidx/appcompat/widget/e1;->c(Landroid/content/Context;I)I
...
.method public d(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/e1;->c(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/e1;->b(Landroid/content/Context;I)I
