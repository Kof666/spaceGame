...
.field private final k:Landroidx/appcompat/widget/h0$f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/h0;->n:Ljava/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    :goto_0
    iput-object p1, p0, Landroidx/appcompat/widget/h0;->k:Landroidx/appcompat/widget/h0$f;
    ...
    :cond_1
    new-instance p1, Landroidx/appcompat/widget/h0$f;

    invoke-direct {p1}, Landroidx/appcompat/widget/h0$f;-><init>()V
...
.method static m(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Landroidx/appcompat/widget/h0;->k(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private s(F)V
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/h0;->k(Ljava/lang/String;)Ljava/lang/reflect/Method;
...
.method private u()Z
    ...
    :cond_1
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/h0;->b([I)[I
...
.method private x(ILandroid/graphics/RectF;)Z
    ...
    invoke-static {v1}, Landroidx/appcompat/widget/h0$a;->b(Landroid/widget/TextView;)I

    move-result v1

    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/h0;->l(I)V
    ...
    invoke-static {p1, v2, v3}, Landroidx/appcompat/widget/h0;->m(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v0, p1, v2, v1}, Landroidx/appcompat/widget/h0;->d(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
...
.method a()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/h0;->k:Landroidx/appcompat/widget/h0$f;

    iget-object v1, p0, Landroidx/appcompat/widget/h0;->i:Landroid/widget/TextView;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/h0$f;->b(Landroid/widget/TextView;)Z
    ...
    :cond_3
    sget-object v2, Landroidx/appcompat/widget/h0;->l:Landroid/graphics/RectF;
    ...
    invoke-direct {p0, v2}, Landroidx/appcompat/widget/h0;->e(Landroid/graphics/RectF;)I
...
.method d(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/h0;->i:Landroid/widget/TextView;

    iget-object v7, p0, Landroidx/appcompat/widget/h0;->h:Landroid/text/TextPaint;

    iget-object v8, p0, Landroidx/appcompat/widget/h0;->k:Landroidx/appcompat/widget/h0$f;
    ...
    invoke-static/range {v2 .. v8}, Landroidx/appcompat/widget/h0$c;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;IILandroid/widget/TextView;Landroid/text/TextPaint;Landroidx/appcompat/widget/h0$f;)Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object p4, p0, Landroidx/appcompat/widget/h0;->i:Landroid/widget/TextView;

    iget-object v0, p0, Landroidx/appcompat/widget/h0;->h:Landroid/text/TextPaint;

    invoke-static {p1, p2, p3, p4, v0}, Landroidx/appcompat/widget/h0$a;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;ILandroid/widget/TextView;Landroid/text/TextPaint;)Landroid/text/StaticLayout;
...
.method l(I)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/h0;->h:Landroid/text/TextPaint;
...
.method o(Landroid/util/AttributeSet;I)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/h0;->a:I
    ...
    :cond_7
    invoke-direct {p0, v1, v3, p1}, Landroidx/appcompat/widget/h0;->z(FFF)V
