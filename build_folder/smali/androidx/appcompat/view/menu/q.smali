...
.field final i:Landroidx/appcompat/widget/y0;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/appcompat/view/menu/g;Landroid/view/View;IIZ)V
    ...
    iput-object p3, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;
...
.method private z()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    invoke-virtual {v3, v0}, Landroidx/appcompat/widget/v0;->z(Landroid/view/View;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    iget v3, p0, Landroidx/appcompat/view/menu/q;->t:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/v0;->C(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/v0;->B(I)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    const/4 v4, 0x2

    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/v0;->E(I)V
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/v0;->D(Landroid/graphics/Rect;)V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    invoke-virtual {v0}, Landroidx/appcompat/widget/v0;->i()V

    iget-object v0, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    invoke-virtual {v0}, Landroidx/appcompat/widget/v0;->e()Landroid/widget/ListView;
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/v0;->o(Landroid/widget/ListAdapter;)V
...
.method public f(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    invoke-virtual {v2}, Landroidx/appcompat/widget/v0;->d()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/view/menu/q;->i:Landroidx/appcompat/widget/y0;

    invoke-virtual {v3}, Landroidx/appcompat/widget/v0;->j()I
    ...
    invoke-static {v5}, Landroidx/core/view/h0;->r(Landroid/view/View;)I
...
.method public t(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/v0;->c(I)V
...
.method public w(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/v0;->m(I)V
