...
function love.update(dt)
    ...
    if gameState == "playing" then
        -- UPPdatera SPELARENS position (cirkeln)
...
function love.draw()
    -- Rita bakgrunden först av allt (längst bak)
    -- 0, 0 är koordinaterna för övre vänstra hörnet
    love.graphics.setColor(1, 1, 1) -- Återställ färg till vit så bilden ser normal ut
